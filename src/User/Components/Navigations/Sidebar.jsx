...
const navItems = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Property Investments", path: "property-investments", pro: false },
      { name: "Property Report", path: "property-investment-report", pro: false },
    ],
  },
  // {
  //   icon: <FaExchangeAlt />,
            ...
            {nav.subItems ? (
              <button
                ...
                ${openSubmenu?.index === index
                    ? "bg-gradient-to-r from-blue-50 to-indigo-50 text-[#4bdd9fe5] shadow-sm border border-blue-100"
              ...
              >
                ...
                ${openSubmenu?.index === index
                    ? "text-[#4bdd9fe5]"
                    : "text-gray-500 group-hover:text-[#4bdd9fe5]"
                  }`}>
                  {nav.icon}
                </span>
                {(isExpanded || isHovered || isMobileOpen) && (
                  <>
                    ...
                    <FaChevronDown
                      ...
                      ${openSubmenu?.index === index
                          ? "rotate-180 text-[#4bdd9fe5]"
                          : "text-gray-400 group-hover:text-[#4bdd9fe5]"
                        }`}
                    />
                  </>
                )}
                    ...
                    <li key={subItem.name}>
                      <Link
                        ...
                        ${isActive(subItem.path)
                            ? "bg-gradient-to-r from-blue-50 to-indigo-50 text-[#4bdd9fe5] shadow-sm"
                      ...
                      >
                        ...
                        {(subItem.new || subItem.pro) && (
                          <span className="relative z-10 flex gap-1.5 ml-2">
                            {subItem.new && (
                              <span className="bg-gradient-to-r from-emerald-500 to-[#4bdd9fe5] text-white text-sm font-semibold px-2 py-0.5 rounded-full shadow-sm">
                                NEW
                              </span>
                            )}
                            {subItem.pro && (
