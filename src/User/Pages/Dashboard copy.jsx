...
const Dashboard = () => {
  ...
  return (
    <div className="text-white p-0 overflow-x-hidden">
      ...
      {/* New Section: User Profile Details */}
      {/* <div className="theme-card-style border-gradient p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="flex justify-between">
            ...
            <span className="font-bold">{dashboardData.user?.first_name || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Last Name</span>
            <span className="font-bold">{dashboardData.user?.last_name || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Email</span>
            <span className="font-bold">{dashboardData.userEmail || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Country</span>
            <span className="font-bold">{dashboardData.user?.country || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">User ID</span>
            <span className="font-bold">{dashboardData.user?.user_id || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Sponsor ID</span>
            <span className="font-bold">{dashboardData.user?.sponsor_id || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Rank</span>
            <span className="font-bold">{dashboardData.user?.rank || "N/A"}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Binary Daily Cap</span>
            <span className="font-bold">{dashboardData.user?.binary_daily_cap || 0}</span>
          </div>
          <div className="flex justify-between">
            <span className="">Verified</span>
            <span className="font-bold">{dashboardData.user?.verified ? "Yes" : "No"}</span>
          </div>
        </div>
      </div> */}
      ...
      <div className="  gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 lg:col-span-2">
          {[
            ...
            {
              title: "Underconstruction Investment",
              value: dashboardData.wallets?.totalUnderconstructionInvestment || "$0.00",
              color: "bg-blue-500",
              icon: <FaDollarSign className="text-white" />,
            },
            {
        ...
        <div className="space-y-5">
          <div className="theme-card-style border-gradient p-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 bg-slate-700 rounded-lg p-3">
              ...
              <button
                onClick={handleCopy}
                className="bg-blue-400 mt-3 sm:mt-0 hover:bg-blue-600 px-4 py-1 rounded text-sm transition-colors"
              >
                {copied ? "Copied!" : "Copy"}
              </button>
            </div>
        ...
        <div className="theme-card-style border-gradient p-6">
          ...
          <div className="space-y-2 text-sm">
            {[
              ...
              {
                label: "ROI + Level",
                value: dashboardData.profitTracker?.earningWithoutCap || "$0.00",
              },
              {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-6 text-center">
        ...
        <div className="theme-card-style border-gradient lg:col-span-2 p-6 text-center">
          ...
          <p className="text-lg font-bold mb-1">GGL UNITRA Token Price</p>
          <p className="text-dark-300 text-sm">
            1 URWA = USD {dashboardData.tokenOverview?.price || "0"}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        <div className="relative theme-card-style border-gradient lg:col-span-2 p-6">
          ...
          <h4 className="text-xl   font-bold mb-4">
            Empowering Decentralized Income with GGL UNITRA
          </h4>
          <p className="   text-sm leading-relaxed">
            GGL UNITRA Project is a next-gen blockchain-based MLM (Multi-Level
